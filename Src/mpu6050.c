...
//																																	(float)(aacz)/lingmin																																		
//																																	);
	OLED_ShowNum_float(0,1,aacx,1);
	OLED_ShowNum_float(0,2,aacy,1);
	OLED_ShowNum_float(0,3,aacz,1);
...
//																																	(float)(tolz)/tuol																																		
//																																	);	
	OLED_ShowNum_float(0,5,tolx,1);
	OLED_ShowNum_float(0,6,toly,1);
	OLED_ShowNum_float(0,7,tolz,1);
} 
